...
export default async function AddTransactionPage({ searchParams }) {
  ...
  return (
    <div className="max-w-4xl mx-auto pb-20 px-6">
      ...
      <div className="flex flex-col mb-12 border-l-4 border-primary pl-8 py-2">
        <h1 className="text-5xl font-black tracking-tighter text-white uppercase italic leading-none">
          ...
          <span className="text-primary block text-sm font-mono mt-2 tracking-[0.3em] not-italic">
      ...
      {/* The "Command Center" Form Wrapper */}
      <div className="relative">
        {/* Background Decorative Elements */}
        <div className="absolute -top-10 -right-10 w-40 h-40 bg-primary/5 blur-[80px] -z-10" />
        <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-accent/5 blur-[80px] -z-10" />

        <div className="glass-card rounded-[2.5rem] p-1 shadow-2xl overflow-hidden">
          {/* Inner focus area */}
          <div className="bg-[#050505]/80 backdrop-blur-2xl rounded-[2.4rem] p-8 md:p-12 border border-white/5">
             <AddTransactionForm
               accounts={accounts}
      ...
      {/* Technical Footer - Makes it look bespoke */}
      <div className="mt-10 flex flex-col md:flex-row justify-between items-center px-8 text-[10px] uppercase tracking-[0.2em] text-slate-600 font-bold gap-4">
