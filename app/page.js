    ...
    <div className="min-h-screen bg-background text-slate-200 overflow-x-hidden">
      ...
      <section className="py-20 md:py-32 bg-white/[0.01] border-y border-white/5">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-black text-white mb-16 md:mb-20 tracking-tighter uppercase italic">How_to_use?</h2>
      ...
      <section id="testimonials" className="py-20 md:py-32">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-black text-white text-center mb-16 md:mb-24 tracking-tighter uppercase italic">Testimonials</h2>
